...
import { getProductCategoryBySlug } from '@/server/product-category/api';
import { getProductsByCategorySlug } from '@/server/product/api';
        ...
        <div>
            ...
            <div className='bg-red-50 p-4'>
                <div className='container mx-auto'>
                    <h1 className='text-2xl md:text-3xl font-bold text-center text-red-600 mb-2'>{productCategory?.title} - UP TO 90% OFF! 🔥</h1>
                    <p className='text-center text-red-500 text-sm md:text-base animate-pulse'>⚡️ Flash Sale Ending Soon! ⏰ Limited Time Only</p>
                    <p className='text-center text-gray-600 text-xs mt-2'>{productCategory?.description}</p>
                </div>
            </div>
