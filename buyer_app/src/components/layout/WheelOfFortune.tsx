                                ...
                                <div className='relative bg-gradient-to-br from-white to-gray-50 p-4 rounded-xl shadow-2xl'>
                                    ...
                                    <div className='relative rounded-lg overflow-hidden border-2 border-yellow-400/50 shadow-[0_0_15px_rgba(234,179,8,0.3)]'>
                                        <Image
                                            ...
                                            alt={product.name || 'Winning Product!'}
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            <DialogContent className='sm:max-w-[800px] p-0'>
                <DialogTitle>
                    <div className='pt-6 text-center relative overflow-hidden h'>
                        ...
                        <p className='text-base text-muted-foreground mb-4 relative animate-pulse'>
                ...
                <div className='flex flex-col items-center justify-center pb-6 gap-4 bg-gray-50'>
                    <div
                        className={`
                            relative w-[300px] h-[300px] md:w-[350px] md:h-[350px] transition-all duration-1000 ease-in-out transform
                    ...
                    <button
                        ...
                        className={`
                            relative px-6 py-2 rounded-full font-bold text-white text-base transition-all
